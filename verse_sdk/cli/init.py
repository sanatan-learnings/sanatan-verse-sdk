...
def print_collection_next_steps(
    ...
    print("      Collection title/card images are generated when OPENAI_API_KEY is available; otherwise they remain pending.")
    print("   6. Then generate collection title/card images explicitly (quick validation):")
    print("      verse-images --verse title-page")
    print("      verse-images --verse card-page")
    print("      # fallback when collection/theme is ambiguous:")
    print(f"      verse-images --collection {collection} --theme {theme} --verse title-page")
    print(f"      verse-images --collection {collection} --theme {theme} --verse card-page")
    ...
    print("")
    print("   ✅ Core flow complete (steps 1-8).")
