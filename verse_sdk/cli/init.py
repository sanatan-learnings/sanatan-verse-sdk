...
"""
    ...
    print(f"   3. Optional: customize theme in data/themes/{collection}/modern-minimalist.yml")
    print("   4. Generate first verse content + assets from canonical YAML:")
    ...
    print(f"   5. Review/edit generated verses in _verses/{collection}/ for quality")
    print("   6. Preview locally and verify output:")
    print("      bundle exec jekyll serve")
    print("   7. Generate full collection:")
    ...
    print("   8. Run: verse-validate")
    print("   9. Optional: verse-embeddings / verse-index-sources / verse-puranic-context / verse-deploy")
...
def init_project(
    ...
    if collections:
        ...
        print("      - Directory mode: data/sources/<collection>/...")
        print("      - Single-file mode: data/sources/<collection>.txt")
        print("   3. Generate canonical YAML from source text:")
        print("      verse-parse-source --collection <collection-key>")
        print("      Output: data/verses/<collection>.yaml")
        print("      (Optional fallback: edit data/verses/<collection>.yaml manually)")
        print("   4. Optional: customize theme in data/themes/<collection>/modern-minimalist.yml")
        print("   5. Generate first verse content + assets from canonical YAML:")
        print("      verse-generate --collection <collection-key> --verse 1 --regenerate-content")
        print("      (Scene descriptions can be auto-generated by verse-generate, or edited in data/scenes manually.)")
        print("   6. Review/edit generated verses in _verses/<collection>/ for quality")
        print("   7. Preview locally and verify output:")
        print("      bundle exec jekyll serve")
        print("   8. Generate full collection:")
        print("      verse-generate --collection <collection-key> --all")
        print("      # or explicit range: verse-generate --collection <collection-key> --verse 1-N")
        print("      # or iterative: verse-generate --collection <collection-key> --next")
