...
This guide walks through publishing `sanatan-verse-sdk` to the Python Package Index (PyPI).
...
3. Name it (e.g., "sanatan-verse-sdk-upload")
...
This creates:
- `dist/sanatan-verse-sdk-0.1.0-py3-none-any.whl` (wheel format)
- `dist/sanatan-verse-sdk-0.1.0.tar.gz` (source distribution)
...
Uploading sanatan-verse-sdk-0.1.0-py3-none-any.whl
Uploading sanatan-verse-sdk-0.1.0.tar.gz
```

View your package: https://test.pypi.org/project/sanatan-verse-sdk/
...
pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ sanatan-verse-sdk
...
View your package: https://pypi.org/project/sanatan-verse-sdk/
...
1. Go to https://github.com/sanatan-learnings/sanatan-verse-sdk/releases
...
**Production PyPI:**
- View package: https://pypi.org/project/sanatan-verse-sdk/
- Manage project: https://pypi.org/manage/projects/

**TestPyPI:**
- View package: https://test.pypi.org/project/sanatan-verse-sdk/
...
- Use a namespace (e.g., `my-sanatan-verse-sdk`)
...
python -m build
pip install dist/sanatan-verse-sdk-*.whl
```
